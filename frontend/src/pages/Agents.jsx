      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>
            Agents{' '}
            <span className="font-normal text-lg" style={{ color: 'var(--text-muted)' }}>({agentList.length})</span>
          </h1>
          <p className="text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>
            Collecte alternative pour les postes, en complément du compte de service AD/SSH — lecture seule.
          </p>
        </div>
        {isAdmin && (
